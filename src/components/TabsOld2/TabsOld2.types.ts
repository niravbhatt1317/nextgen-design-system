 ...
 */
export type TabsOld2Variant = 'default' | 'underline' | 'card' | 'pills';

/**
 * Props for the Tabs root component
 */
export interface TabsOld2Props extends ComponentPropsWithoutRef<typeof TabsPrimitive.Root> {
  /**
...
/**
 * Props for the TabsListOld2 component
 */
export interface TabsListOld2Props extends ComponentPropsWithoutRef<typeof TabsPrimitive.List> {
  /**
   * Visual style variant
   * @default 'default'
   */
  variant?: TabsOld2Variant;
...
/**
 * Props for the TabsTriggerOld2 component
 */
export interface TabsTriggerOld2Props extends ComponentPropsWithoutRef<
...
> {
  ...
  /**
   * Visual style variant (should match TabsListOld2 variant)
   * @default 'default'
   */
  variant?: TabsOld2Variant;
 ...
 */
export interface TabsAddOld2Props extends ComponentPropsWithoutRef<'button'> {
  /**
...
/**
 * Props for the TabsContentOld2 component
 */
export interface TabsContentOld2Props extends ComponentPropsWithoutRef<
