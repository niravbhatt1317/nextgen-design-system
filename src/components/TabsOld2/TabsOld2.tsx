 ...
 * @deprecated Since 1.0.0. Use `Tabs` instead — two types in place of four variants.
 *
 ...
 * ```
 */
const TabsOld2 = forwardRef<React.ElementRef<typeof TabsPrimitive.Root>, TabsOld2Props>(
  ({ className, ...props }, ref) => (
    <TabsPrimitive.Root ref={ref} className={cn('mdt-w-full', className)} {...props} />
  )
);
TabsOld2.displayName = 'TabsOld2';

/**
 * TabsListOld2 - container for tab triggers.
 */
const TabsListOld2 = forwardRef<React.ElementRef<typeof TabsPrimitive.List>, TabsListOld2Props>(
...
TabsListOld2.displayName = 'TabsListOld2';

/**
 * TabsTriggerOld2 - individual tab button.
 *
 ...
 */
const TabsTriggerOld2 = forwardRef<
...
TabsTriggerOld2.displayName = 'TabsTriggerOld2';

/**
 * TabsAddOld2 - the control that makes a new tab.
 *
 ...
 */
const TabsAddOld2 = forwardRef<HTMLButtonElement, TabsAddOld2Props>(
...
TabsAddOld2.displayName = 'TabsAddOld2';

/**
 * TabsContentOld2 - content panel for each tab.
 */
const TabsContentOld2 = forwardRef<
...
TabsContentOld2.displayName = 'TabsContentOld2';

export { TabsOld2, TabsListOld2, TabsTriggerOld2, TabsContentOld2, TabsAddOld2 };
