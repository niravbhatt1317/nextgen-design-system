...
import { SelectOptionOld2 } from './SelectOld2.types';

const simpleOptions: SelectOptionOld2[] = [
...
const groupedOptions: SelectOptionOld2[] = [
...
const optionsWithDescriptions: SelectOptionOld2[] = [
...
describe('SelectOld2', () => {
  describe('Rendering', () => {
    it('renders with placeholder', () => {
      render(<SelectOld2 options={simpleOptions} placeholder="SelectOld2 option..." />);
      expect(screen.getByText('SelectOld2 option...')).toBeInTheDocument();
    });

    it('renders with label', () => {
      render(<SelectOld2 options={simpleOptions} label="Test Label" />);
      expect(screen.getByText('Test Label')).toBeInTheDocument();
    });

    it('renders with helper text', () => {
      render(<SelectOld2 options={simpleOptions} helperText="Helper text" />);
      expect(screen.getByText('Helper text')).toBeInTheDocument();
    });

    it('renders with error message', () => {
      render(<SelectOld2 options={simpleOptions} error="Error message" />);
    ...
    it('renders required asterisk when required', () => {
      render(<SelectOld2 options={simpleOptions} label="Required Field" required />);
      expect(screen.getByText('*')).toBeInTheDocument();
    });
  });

  describe('Single SelectOld2 Mode', () => {
    it('opens dropdown on click', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 options={simpleOptions} placeholder="SelectOld2..." />);
    ...
    it('selects an option', async () => {
      ...
      render(
        <SelectOld2 options={simpleOptions} onChange={handleChange} placeholder="SelectOld2..." />
      );
  ...
  describe('Disabled State', () => {
    it('does not open when disabled', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 options={simpleOptions} disabled placeholder="SelectOld2..." />);
    ...
    it('has disabled attribute when disabled', () => {
      render(<SelectOld2 options={simpleOptions} disabled />);
      const trigger = screen.getByRole('combobox');
  ...
  describe('Size Variants', () => {
    it('applies small size class', () => {
      render(<SelectOld2 options={simpleOptions} size="sm" />);
      const trigger = screen.getByRole('combobox');
      expect(trigger).toHaveClass('mdt-h-8');
    });

    it('applies medium size class', () => {
      render(<SelectOld2 options={simpleOptions} size="md" />);
      const trigger = screen.getByRole('combobox');
      expect(trigger).toHaveClass('mdt-h-9');
    });

    it('applies large size class', () => {
      render(<SelectOld2 options={simpleOptions} size="lg" />);
      const trigger = screen.getByRole('combobox');
  ...
  describe('Options with Icons and Avatars', () => {
    it('renders options with icons', async () => {
      const user = userEvent.setup();
      const optionsWithIcons: SelectOptionOld2[] = [
        {
          value: '1',
          label: 'With Icon',
      ...
      render(<SelectOld2 options={optionsWithIcons} placeholder="SelectOld2..." />);
    ...
    it('renders options with avatars', async () => {
      const user = userEvent.setup();
      const optionsWithAvatars: SelectOptionOld2[] = [
        {
          value: '1',
          label: 'User 1',
      ...
      render(<SelectOld2 options={optionsWithAvatars} placeholder="SelectOld2..." />);
    ...
    it('renders options with descriptions', async () => {
      const user = userEvent.setup();
      const optionsWithDesc: SelectOptionOld2[] = [
        {
          value: '1',
      ...
      render(<SelectOld2 options={optionsWithDesc} placeholder="SelectOld2..." />);
  ...
  describe('Accessibility', () => {
    ...
    it('associates error message with input', () => {
      render(<SelectOld2 options={simpleOptions} error="Error message" id="test-select" />);
  ...
  describe('Custom className', () => {
    it('applies custom className to trigger', () => {
      render(<SelectOld2 options={simpleOptions} className="custom-class" />);
      const trigger = screen.getByRole('combobox');
    ...
    it('applies custom wrapperClassName', () => {
      const { container } = render(
        <SelectOld2 options={simpleOptions} wrapperClassName="wrapper-class" />
      );
  ...
  describe('Empty State', () => {
    it('shows empty message when no options', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 options={[]} placeholder="SelectOld2..." emptyMessage="No items found" />);
  ...
  describe('Multi-select Mode', () => {
    it('renders multi-select with placeholder', () => {
      render(
        <SelectOld2 mode="multiple" options={simpleOptions} placeholder="SelectOld2 items..." />
      );
      expect(screen.getByText('SelectOld2 items...')).toBeInTheDocument();
    });

    it('opens dropdown and shows options on click', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 mode="multiple" options={simpleOptions} />);
    ...
    it('displays pills when showPills is true', () => {
      render(<SelectOld2 mode="multiple" options={simpleOptions} value={['1', '2']} showPills />);
    ...
    it('filters options based on search query', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 mode="multiple" options={simpleOptions} searchable />);
    ...
    it('shows "X selected" without pills when multiple selected', () => {
      render(<SelectOld2 mode="multiple" options={simpleOptions} value={['1', '2']} />);
    ...
    it('shows select all button and selects all non-disabled options', async () => {
      ...
      render(
        <SelectOld2 mode="multiple" options={simpleOptions} onChange={handleChange} selectAll />
      );
      ...
      await waitFor(() => {
        expect(screen.getByText(/SelectOld2 all/)).toBeInTheDocument();
      });

      await user.click(screen.getByText(/SelectOld2 all/));
    ...
    it('shows loading state', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 mode="multiple" options={simpleOptions} loading />);
    ...
    it('shows load more button when hasMore and loadMore provided', async () => {
      ...
      render(<SelectOld2 mode="multiple" options={simpleOptions} hasMore loadMore={loadMore} />);
    ...
    it('shows grouped options when grouped is true', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 mode="multiple" options={groupedOptions} grouped />);
    ...
    it('selects option in grouped mode', async () => {
      ...
      render(
        <SelectOld2 mode="multiple" options={groupedOptions} onChange={handleChange} grouped />
      );
    ...
    it('shows options with descriptions in multi-select', async () => {
      const user = userEvent.setup();
      render(<SelectOld2 mode="multiple" options={optionsWithDescriptions} />);
    ...
    it('uses custom filterFn for search', async () => {
      const user = userEvent.setup();
      const customFilter = vi.fn((option: SelectOptionOld2, query: string) =>
        option.label.startsWith(query)
      );

      render(
        <SelectOld2 mode="multiple" options={simpleOptions} searchable filterFn={customFilter} />
      );
    ...
    it('renders options with avatars in multi-select', async () => {
      ...
      render(<SelectOld2 mode="multiple" options={optionsWithAvatars} />);
    ...
    it('renders options with icons in multi-select', async () => {
      ...
      render(<SelectOld2 mode="multiple" options={optionsWithIcons} />);
    ...
    it('shows selected on top with separator when showSelectedOnTop is true', async () => {
      const user = userEvent.setup();
      render(
        <SelectOld2 mode="multiple" options={simpleOptions} value={['3']} showSelectedOnTop />
      );
    ...
    it('renders with borderless variant in multi-select', () => {
      render(<SelectOld2 mode="multiple" options={simpleOptions} variant="borderless" />);
    ...
    it('supports uncontrolled mode with defaultValue', () => {
      render(<SelectOld2 mode="multiple" options={simpleOptions} defaultValue={['1', '2']} />);

      expect(screen.getByText('2 selected')).toBeInTheDocument();
    });

    it('renders pills with avatar and icon in pills', () => {
      const optionsWithExtras: SelectOptionOld2[] = [
        { value: '1', label: 'User 1', avatar: 'https://example.com/a.jpg' },
        { value: '2', label: 'Star Item', icon: <span data-testid="pill-icon">⭐</span> },
      ];

      render(
        <SelectOld2 mode="multiple" options={optionsWithExtras} value={['1', '2']} showPills />
      );
    ...
    it('renders disabled option in multi-select as non-interactive', async () => {
      ...
      render(<SelectOld2 mode="multiple" options={simpleOptions} onChange={handleChange} />);
    ...
    it('shows helper text when no error in multi-select', () => {
      render(
        <SelectOld2 mode="multiple" options={simpleOptions} helperText="SelectOld2 one or more" />
      );

      expect(screen.getByText('SelectOld2 one or more')).toBeInTheDocument();
    });
  });

  describe('Single SelectOld2 Advanced Features', () => {
    ...
    it('shows prefix icon in single select', () => {
      render(
        <SelectOld2 options={simpleOptions} prefixIcon={<span data-testid="prefix">🔍</span>} />
      );
    ...
    it('renders with borderless variant in single select', () => {
      render(<SelectOld2 options={simpleOptions} variant="borderless" />);
    ...
    it('renders controlled single select with value', () => {
      render(<SelectOld2 options={simpleOptions} value="1" />);
    ...
    it('clears single select via keyboard', async () => {
      ...
      render(<SelectOld2 options={simpleOptions} value="1" onChange={handleChange} clearable />);
    ...
    it('associates helper text with input via aria-describedby in single select', () => {
      render(<SelectOld2 options={simpleOptions} helperText="Pick one" id="my-select" />);
    ...
    it('renders with showSelectedOnTop in single select', () => {
      render(<SelectOld2 options={simpleOptions} value="2" showSelectedOnTop />);
    ...
    it('supports uncontrolled single select with defaultValue', () => {
      render(<SelectOld2 options={simpleOptions} defaultValue="1" />);
    ...
    it('renders label and required asterisk for single select', () => {
      render(<SelectOld2 options={simpleOptions} label="Country" required />);
    ...
    it('renders error message for single select', () => {
      render(<SelectOld2 options={simpleOptions} error="Selection required" />);
  ...
  describe('Multi-SelectOld2 Clearable', () => {
    it('renders clearable multi-select with selected values', () => {
      render(<SelectOld2 mode="multiple" options={simpleOptions} value={['1', '2']} clearable />);
  ...
  describe('Multi-SelectOld2 Grouped Options', () => {
    ...
    it('selects option from grouped multi-select', async () => {
      ...
      render(
        <SelectOld2 mode="multiple" options={groupedOptions} grouped onChange={handleChange} />
      );
  ...
  describe('Multi-SelectOld2 with renderItem', () => {
  ...
  describe('Multi-SelectOld2 renderTrigger', () => {
  ...
  describe('Multi-SelectOld2 Options with Descriptions', () => {
  ...
  describe('Multi-SelectOld2 Pill Removal Keyboard', () => {
  ...
  describe('Single SelectOld2 Clearable with Keyboard Space', () => {
  ...
  describe('Multi-SelectOld2 Borderless with Clearable', () => {
  ...
  describe('Multi-SelectOld2 Open/Close Callbacks', () => {
  ...
  describe('Single SelectOld2 Clear via Enter Key', () => {
  ...
  describe('Single SelectOld2 with showSelectedOnTop', () => {
  ...
  describe('Multi-SelectOld2 Grouped with renderItem', () => {
  ...
  describe('Multi-SelectOld2 with showSelectedOnTop', () => {
  ...
  describe('Single SelectOld2 with name prop', () => {
    it('passes name attribute in single select mode', () => {
      render(<SelectOld2 options={simpleOptions} name="my-select" placeholder="SelectOld2..." />);

      expect(screen.getByText('SelectOld2...')).toBeInTheDocument();
    });
  });

  describe('Single SelectOld2 Borderless Clearable', () => {
    it('renders borderless clearable single select', () => {
      render(<SelectOld2 options={simpleOptions} value="1" variant="borderless" clearable />);
  ...
  describe('Virtualized Options Rendering', () => {
    it('renders virtualized options with many items and scrolling', async () => {
      ...
      const manyOptions: SelectOptionOld2[] = Array.from({ length: 100 }, (_, i) => ({
        value: `${i + 1}`,
        label: `Option ${i + 1}`,
      }));

      const { container } = render(<SelectOld2 mode="multiple" options={manyOptions} />);
    ...
    it('renders selected option in virtualized list', async () => {
      ...
      const manyOptions: SelectOptionOld2[] = Array.from({ length: 50 }, (_, i) => ({
        value: `${i + 1}`,
        label: `Option ${i + 1}`,
      }));

      render(<SelectOld2 mode="multiple" options={manyOptions} value={['5', '10']} />);
