...
import type { badgeOldVariants } from './BadgeOld';

export type BadgeOldVariantsType = VariantProps<typeof badgeOldVariants>;
 ...
 * ships.
 */
export type BadgeOldTone = 'neutral' | 'info' | 'success' | 'warning' | 'danger' | 'ai';
 ...
 */
export type BadgeOldEmphasis = 'subtle' | 'outline' | 'solid';
 ...
 */
export type BadgeOldShape = 'pill' | 'square';

export type BadgeOldSize = 'sm' | 'md' | 'lg';

export interface BadgeOldOwnProps {
  /** What the badge means. @default 'neutral' */
  tone?: BadgeOldTone;

  /** How loud the badge is. @default 'subtle' */
  emphasis?: BadgeOldEmphasis;
  ...
  /**
   * Caps a numeric label. `<BadgeOld max={99}>1284</BadgeOld>` renders `99+`.
   *
...
export type BadgeOldProps = BadgeOldOwnProps &
