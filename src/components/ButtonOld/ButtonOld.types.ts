...
import type { ButtonOldVariants } from './ButtonOld';

/**
 * ButtonOld component variants derived from CVA configuration
 */
export type ButtonOldVariantsType = VariantProps<typeof ButtonOldVariants>;

/**
 * Shape options for button corners
 */
export type ButtonOldShape = 'square' | 'rounded' | 'pill' | 'circle';

/**
 * Semantic color options
 */
export type ButtonOldColor = 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info';

/**
 * Shadow elevation levels
 */
export type ButtonOldElevation = 0 | 1 | 2 | 3;
...
/**
 * ButtonOld size options (for internal mappings)
 */
export type ButtonOldSize = 'sm' | 'md' | 'lg';
 ...
 */
interface BaseButtonProps extends ComponentPropsWithoutRef<'button'>, ButtonOldVariantsType {
  /**
...
interface LinkButtonProps
  extends Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'href'>, ButtonOldVariantsType {
  /**
...
interface CommonButtonProps {
  ...
  /**
   * ButtonOld corner shape style
   * @default 'rounded'
   */
  shape?: ButtonOldShape;

  /**
   * Semantic color variant
   */
  color?: ButtonOldColor;

  /**
   * Shadow depth elevation (0=flat, 3=raised)
   * @default 0
   */
  elevation?: ButtonOldElevation;
   ...
   * `<ButtonOld variant="ai" success>` is an AI button reporting that it is done.
   *
   * @default false
   */
  success?: boolean;
...
/**
 * Props for the ButtonOld component
 * Supports both button and link (anchor) rendering
 */
export type ButtonOldProps = (BaseButtonProps | LinkButtonProps) & CommonButtonProps;
