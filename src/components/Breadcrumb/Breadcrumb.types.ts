 ...
 *
 * `page` is the header band's crumb: 12/500 in the quiet ink, the place you
 ...
 * the title's own 16: the parent at 400 in the quiet ink, the step at 600 in
...
export interface BreadcrumbItem {
  /** What the place is called. Truncates with a `title` when it is a string and not the last. */
  label: ReactNode;
