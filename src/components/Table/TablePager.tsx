...
function TablePager({
  ...
  return (
    <div className="tbl-foot mdt-flex mdt-h-[49px] mdt-items-center mdt-justify-between mdt-border-t mdt-border-solid mdt-border-neutral-20 mdt-bg-card mdt-px-4 mdt-py-2 mdt-text-[13px] mdt-font-medium mdt-leading-[1.5] mdt-text-neutral-90">
...
function TableLoadMore({ shown, total, noun, loading = false, onMore }: TableLoadMoreProps) {
  return (
    <div className="tbl-foot mdt-flex mdt-h-[49px] mdt-items-center mdt-justify-center mdt-gap-3 mdt-border-t mdt-border-solid mdt-border-neutral-20 mdt-bg-card mdt-text-[13px] mdt-font-medium mdt-text-neutral-90">
      <span>
