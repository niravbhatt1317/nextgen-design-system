...
import type { TableBulkActionOldProps, TableBulkBarOldProps } from './TableOld.types';
...
/**
 * TableBulkBarOld - what you can do with the rows you have selected.
 *
 ...
 */
const TableBulkBarOld = forwardRef<HTMLDivElement, TableBulkBarOldProps>(
...
TableBulkBarOld.displayName = 'TableBulkBarOld';
 ...
 */
const TableBulkActionOld = forwardRef<HTMLButtonElement, TableBulkActionOldProps>(
...
TableBulkActionOld.displayName = 'TableBulkActionOld';

/** A divider between groups of actions - destructive from routine, usually. */
const TableBulkSeparatorOld = () => (
  <span aria-hidden className="mdt-h-5 mdt-w-px mdt-bg-primary-foreground/25" />
);
TableBulkSeparatorOld.displayName = 'TableBulkSeparatorOld';

export { TableBulkBarOld, TableBulkActionOld, TableBulkSeparatorOld };
