...
describe('TableFilterMenuOld', () => {
  describe('picking an attribute', () => {
    it('lists what can be filtered', async () => {
      render(
        <TableFilterMenuOld attributes={attributes} valuesFor={() => []} onToggleValue={vi.fn()} />
      );
      await open();
