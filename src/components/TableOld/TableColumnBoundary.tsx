...
import type { TableColumnBoundaryOldProps } from './TableOld.types';
...
/**
 * TableColumnBoundaryOld - one line between two columns, doing both jobs.
 *
...
TableColumnBoundaryOld.displayName = 'TableColumnBoundaryOld';

export { TableColumnBoundaryOld };
