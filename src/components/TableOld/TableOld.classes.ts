/**
 * The class strings behind TableOld's pinned surfaces.
 *
 * Lifted out of `TableOld.tsx` when that file crossed the 1000-line limit. Only
 ...
 *
 * `TableHeadOld` measures its own width during a drag, so it needs a ref of its
