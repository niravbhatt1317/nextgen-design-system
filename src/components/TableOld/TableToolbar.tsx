...
import type { TableToolbarActionsOldProps, TableToolbarOldProps } from './TableOld.types';
...
/**
 * TableToolbarOld - the controls that act on the whole table.
 *
 * The line between this and `TableColumnMenuOld` is what each one acts on. The
 ...
 * `TableToolbarActionsOld`, which pushes them to the trailing edge.
 *
 * @example
 * ```tsx
 * <TableToolbarOld>
 ...
 */
const TableToolbarOld = forwardRef<HTMLDivElement, TableToolbarOldProps>(
  ({ className, label = 'TableOld controls', ...props }, ref) => (
    <div
      ref={ref}
...
TableToolbarOld.displayName = 'TableToolbarOld';
 ...
 * `Toolbar` instead.
 */
const TableToolbarActionsOld = forwardRef<HTMLDivElement, TableToolbarActionsOldProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
...
TableToolbarActionsOld.displayName = 'TableToolbarActionsOld';

export { TableToolbarOld, TableToolbarActionsOld };
