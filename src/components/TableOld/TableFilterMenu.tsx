...
import type { TableFilterMenuOldProps } from './TableOld.types';

/**
 * TableFilterMenuOld - choose an attribute, then choose its values.
 *
...
TableFilterMenuOld.displayName = 'TableFilterMenuOld';

export { TableFilterMenuOld };
