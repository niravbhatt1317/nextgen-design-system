...
export interface UseColumnReorderOldOptions<K extends string = string> {
...
export interface ColumnGripOldProps {
...
export interface UseColumnReorderOld<K extends string = string> {
  ...
  gripProps: (key: K) => ColumnGripOldProps;
 ...
 */
export function useColumnReorderOld<K extends string>({
  columns,
  onMove,
  frozenCount = 0,
  threshold = DEFAULT_THRESHOLD,
}: UseColumnReorderOldOptions<K>): UseColumnReorderOld<K> {
