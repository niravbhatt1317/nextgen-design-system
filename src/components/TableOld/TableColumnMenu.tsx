...
import type { TableColumnMenuOldProps } from './TableOld.types';
...
/**
 * TableColumnMenuOld - the controls that belong to one column.
 *
 ...
 * about this column". Both read the same `useTableColumnsOld` state, so they
...
TableColumnMenuOld.displayName = 'TableColumnMenuOld';

export { TableColumnMenuOld };
