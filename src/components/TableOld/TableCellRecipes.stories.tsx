 ...
 */
const meta: Meta = {
  title: 'Deprecated/Table Old Cell Recipes',
  tags: ['autodocs'],
  parameters: {
    status: {
      type: 'deprecated',
    ...
    return (
      <div className="mdt-flex mdt-flex-col mdt-gap-3">
        <TableOld>
          ...
          <TableBodyOld>
            {rows.map((row) => (
              <TableRowOld key={row.id} className="mdt-group/row">
    ...
    return (
      <div className="mdt-flex mdt-flex-col mdt-gap-3">
        <TableOld>
          ...
          <TableBodyOld>
            {tickets.map((ticket) => (
              <TableRowOld key={ticket.id} className="mdt-group/row">
                <TableCellOld className="mdt-font-medium">{ticket.id}</TableCellOld>
                <TableCellOld>
                  <div className="mdt-flex mdt-items-center mdt-gap-2">
