...
import type { TableSortMenuOldProps } from './TableOld.types';
...
/**
 * TableSortMenuOld - which columns sort the table, and in what order.
 *
...
TableSortMenuOld.displayName = 'TableSortMenuOld';

export { TableSortMenuOld };
