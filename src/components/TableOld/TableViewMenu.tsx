...
import type { TableViewMenuOldProps } from './TableOld.types';
...
/**
 * TableViewMenuOld - grouping and which columns exist.
 *
...
TableViewMenuOld.displayName = 'TableViewMenuOld';

export { TableViewMenuOld };
