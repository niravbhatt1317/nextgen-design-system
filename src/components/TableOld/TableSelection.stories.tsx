 ...
 */
const meta: Meta = {
  title: 'Deprecated/Table Old Bulk Actions',
  tags: ['autodocs'],
...
export const RowSelection: Story = {
  render: function RowSelectionDemo() {
    ...
    const selection = useTableSelectionOld({ rowIds: rows.map((ticket) => ticket.id) });
    ...
    return (
      <div className="mdt-flex mdt-flex-col mdt-gap-2">
        ...
        <TableOld containerClassName="mdt-rounded-md mdt-border">
          ...
          <TableBodyOld>
            {rows.map((ticket) => (
              <TableRowOld key={ticket.id} selected={selection.isSelected(ticket.id)}>
                <TableCellOld>
                  {/*
