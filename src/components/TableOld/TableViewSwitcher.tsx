...
import type { TableViewNamePanelOldProps, TableViewSwitcherOldProps } from './TableOld.types';
...
/**
 * TableViewSwitcherOld - the saved views, and what you can do to them.
 *
 ...
 * way `TableFilterMenuOld` drills into an attribute. A text field inside a command
...
TableViewSwitcherOld.displayName = 'TableViewSwitcherOld';

export { TableViewSwitcherOld, TableViewNamePanel };
