...
const COLUMNS: TableColumnsPanelColumnOld2[] = [
...
function columnsPanel(overrides: Partial<Parameters<typeof TableColumnsPanelOld2>[0]> = {}) {
  const handlers = {
    onToggle: vi.fn(),
    onHideAll: vi.fn(),
    onShowAll: vi.fn(),
...
describe('TableColumnsPanelOld2', () => {
...
function insertPanel(overrides: Partial<Parameters<typeof TableInsertPanelOld2>[0]> = {}) {
  const onPick = vi.fn();
  const onOpenChange = vi.fn();
