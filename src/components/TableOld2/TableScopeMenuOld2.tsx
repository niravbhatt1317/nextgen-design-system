...
import type { TableScopeMenuOld2Props, TableSelectionScopeOld2 } from './TableOld2.types';
...
function TableScopeMenuOld2({
  ...
  noun,
  onApply,
}: TableScopeMenuOld2Props) {
  const [choice, setChoice] = useState<TableSelectionScopeOld2>('page');
  ...
  const options: { value: TableSelectionScopeOld2; label: string; count: number | null }[] = [
    ...
    <Popover open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="mdt-mt-2.5 mdt-flex mdt-justify-end mdt-gap-2 mdt-border-t mdt-border-solid mdt-border-neutral-20 mdt-pt-2.5">
          ...
          <button
            type="button"
            className="mdt-h-8 mdt-rounded-lg mdt-border-0 mdt-bg-neutral-150 mdt-px-3 mdt-text-[13px] mdt-font-semibold mdt-text-white"
            onClick={apply}
          >
            Apply
          </button>
