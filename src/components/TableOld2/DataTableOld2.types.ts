...
export interface DataTableQuickFilterOld2<Row> {
...
export interface DataTableFilterGroupOld2<Row> {
  key: string;
  label: string;
  options: string[];
...
export interface DataTableBlankCopyOld2 {
...
export interface DataTableNameColumnOld2<Row> {
...
export interface DataTableOld2Props<Row> {
  ...
  nameColumn: DataTableNameColumnOld2<Row>;
   ...
   */
  quickFilter?: DataTableQuickFilterOld2<Row> | DataTableQuickFilterOld2<Row>[] | undefined;
  filters?: DataTableFilterGroupOld2<Row>[] | undefined;
  ...
  paging?: TablePagingModeOld2 | undefined;
  ...
  blank?: Partial<Record<TableBlankKindOld2, DataTableBlankCopyOld2>> | undefined;
