  ...
  function TableBulkBarOld2({ className, count, onScope, onClear, children, ...props }, ref) {
    ...
    return (
      ...
      >
        <button
          type="button"
          className="mdt-inline-flex mdt-h-8 mdt-items-center mdt-gap-2 mdt-rounded-lg mdt-border-0 mdt-bg-transparent mdt-pl-0 mdt-pr-2.5 mdt-font-semibold mdt-text-[#7C88A2] hover:mdt-text-white"
        ...
        <span className="mdt-mx-1.5 mdt-h-5 mdt-w-px mdt-bg-white/20" aria-hidden="true" />
        {children}
        <button
          type="button"
          className="mdt-inline-flex mdt-h-8 mdt-w-8 mdt-items-center mdt-justify-center mdt-rounded-lg mdt-border-0 mdt-bg-transparent mdt-p-0 mdt-text-[#B5BFD1] hover:mdt-bg-white/10 hover:mdt-text-white"
    ...
    return (
      <button
        ...
        className={cn(
          ...
          'hover:mdt-bg-white/10 disabled:mdt-cursor-default disabled:mdt-opacity-40',
          '[&_svg]:mdt-size-4',
...
function TableBulkSeparatorOld2() {
  return <span className="mdt-mx-1.5 mdt-h-5 mdt-w-px mdt-bg-white/20" aria-hidden="true" />;
}
