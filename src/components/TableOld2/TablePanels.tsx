...
export interface TableColumnsPanelColumnOld2 {
  key: string;
  label: string;
  hidden: boolean;
}

export interface TableColumnsPanelOld2Props {
  /** The control that opens the panel, usually a ToolbarButton. */
  trigger: ReactNode;
  /** Columns in display order, hidden ones included. */
  columns: TableColumnsPanelColumnOld2[];
 ...
 */
function TableColumnsPanelOld2({
  trigger,
  columns,
  locked = [],
  onToggle,
...
export interface TableInsertPanelOld2Props {
  open: boolean;
  onOpenChange: (open: boolean) => void;
...
export { TableColumnsPanelOld2, TableInsertPanelOld2 };
