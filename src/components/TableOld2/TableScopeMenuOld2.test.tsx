...
function setup(overrides: Partial<Parameters<typeof TableScopeMenuOld2>[0]> = {}) {
  const onApply = vi.fn();
...
describe('TableScopeMenuOld2', () => {
  ...
  it('returns to this page each time it opens', async () => {
    ...
    rerender(<TableScopeMenuOld2 {...props} open={false} />);
    rerender(<TableScopeMenuOld2 {...props} open />);
