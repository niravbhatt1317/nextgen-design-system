...
import type { MotadataSwitchOld2Props } from './SwitchOld2.types';

/**
 * Switch root variants using Class Variance Authority (CVA)
 */
export const motadataSwitchOld2RootVariants = cva(
  [
    'mdt-group',
    'mdt-peer',
    'mdt-inline-flex',
 ...
 */
export const motadataSwitchOld2ThumbVariants = cva(
  [
 ...
 * @deprecated Since 1.0.0. Use `MotadataSwitch` instead — the track with a hover.
 *
 ...
 * MotadataSwitchOld2 component - A toggle switch control.
 *
 ...
 *
 * // Controlled switch
 * <MotadataSwitchOld2 checked={isEnabled} onCheckedChange={setIsEnabled} />
 *
 * // Different sizes
 * <MotadataSwitchOld2 size="sm" />
 * <MotadataSwitchOld2 size="md" />
 * <MotadataSwitchOld2 size="lg" />
 *
 * // Disabled switch
 * <MotadataSwitchOld2 disabled />
 *
 * // With label
 ...
 * ```
 */
const MotadataSwitchOld2 = forwardRef<
  React.ElementRef<typeof SwitchPrimitives.Root>,
  MotadataSwitchOld2Props
>(({ className, size, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(motadataSwitchOld2RootVariants({ size }), className)}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb className={cn(motadataSwitchOld2ThumbVariants({ size }))} />
  </SwitchPrimitives.Root>
));

MotadataSwitchOld2.displayName = 'MotadataSwitchOld2';

export { MotadataSwitchOld2 };
