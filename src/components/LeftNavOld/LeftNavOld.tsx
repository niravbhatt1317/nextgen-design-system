...
/**
 * LeftNavOld - the navigation down the left of a settings area.
 *
 ...
 * ```
 *
 * @deprecated Since 0.4.0. Use `LeftNav`, the product navigation, instead. This
 * settings-only arrangement stays only until its replacement is approved; its parts keep
 * their names until the removal pull request.
 */
const LeftNavOld = forwardRef<HTMLElement, LeftNavOldProps>(
...
LeftNavOld.displayName = 'LeftNavOld';
